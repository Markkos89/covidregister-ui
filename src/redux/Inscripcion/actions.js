...
export const ingresar = (dni) => async dispatch => {
    ...
    function request(user) { return { type: inscripcionConstants.INSCRIPCION_REQUEST, user } }
    function success(user) { return { type: inscripcionConstants.INSCRIPCION_SUCCESS, user } }
    function failure(error) { return { type: inscripcionConstants.INSCRIPCION_FAILURE, error } }
}